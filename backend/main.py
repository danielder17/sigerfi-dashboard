...
from routes import projects, forms, reports, auth, etl, queries, cache_admin, source, export_routes, media, dpt_labels, edificaciones_3d
...
app.include_router(edificaciones_3d.router)
