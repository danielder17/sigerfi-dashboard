...
async def get_edificaciones_3d(project_id: int, form_id: str):
    ...
    try:
        ...
        for sub in subs:
            ...
            # poligono puede ser dict o string JSON
            ...
            # Cerrar el anillo: si el primer punto != último punto, duplicar
            first = coords[0]
            last = coords[-1]
            ...
            # Ubicación (centroide aproximado)
            ubicacion = sub.get("ubicacion", {})
            ...
            # Calcular centro del polígono para el popup
